 ...
 * [Documentation Site](https://nehemming.github.io/cirocket/)
...
>
>There is a new work in progress [Documentation Site](https://nehemming.github.io/cirocket/).
>Additional documentation sources include this README, cli help (`cirocket --help`) and the sample config file generated by running `cirocket init mission`
>
